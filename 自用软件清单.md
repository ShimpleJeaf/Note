...
| Cppcheck              | C/C++静态代码分析工具。vs插件：https://github.com/VioletGiraffe/cppcheck-vs-addin | Windows、Linux、macOS | 免费、开源              |
...
| natapp                 | 内网穿透软件，免费版限速1Mbps，不限流量                                                                                                                                           | Windows、Linux、MacOS、Android     | 有免费套餐                    |
| ngrok                  | 内网穿透软件                                                                                                                                                           |                                 |                          |
| FastSend               | 在线文件点对点传输，无需下载软件，[https://fastsend.ing/](https://fastsend.ing/)                                                                                                  | 网页                              |                          |
| 皎月连                    | P2P内网穿透软件，穿透成功率极高，延迟极低，[https://www.natpierce.cn/](https://www.natpierce.cn/)                                                                                    | Windows、Android                 | 免费（签到）、收费（3元/月）          |
| ZeroTier               | P2P异地组网工具                                                                                                                                                        | 全平台                             | 免费3个网络，共10台设备            |
| Easytier               | 去中心化P2P异地组网工具，无需账号，服务器在国内<br>Linux可用easytier-cli service install [arg]注册系统服务，后面接需要启动的参数，如-c config.yaml                                                          | 全平台                             | LGPL-3.0                 |
| v2rayN                 | 代理软件，**Windows上singbox的tun模式和热点有冲突**。<br>延迟测试地址：https://twitter.com/favicon.ico<br>测速文件地址：https://github.com/2dust/v2rayN/releases/download/3.21/v2rayN-Core.zip | 全平台                             | GPL-3.0                  |
| iVentory               | 通过lan安装系统                                                                                                                                                        | Windows、Linux                   |                          |

## 软件使用注意事项

### Marktext

marktext可能会出现保存后内容丢失的问题，找到preferences.json，把watcherUsePolling改为true
...
[GitHub - KDAB/codebrowser: Woboq CodeBrowser](https://github.com/KDAB/codebrowser)

在线代码浏览（需要梯子）：

[Explore C, C++, Rust & Dart code on the web](https://codebrowser.dev/)

## code-browser

用Woboq CodeBrowser已经生成好的网页，克隆貌似有问题，直接下载zip包

[GitHub - DavidingPlus/code-browser: C++ 开源库源代码浏览网站。](https://github.com/DavidingPlus/code-browser)
...
[Code Browser | DavidingPlus](https://davidingplus.github.io/code-browser/)

## facefusion

[GitHub - facefusion/facefusion: Industry leading face manipulation platform](https://github.com/facefusion/facefusion)

## JKQTPlotter

Qt图表、公式渲染库

[GitHub - JKQtPlotter/doc at master · jkriege2/JKQtPlotter ](https://github.com/jkriege2/JKQtPlotter/tree/master/doc)

## AutoJs6

[GitHub - SuperMonster003/AutoJs6: 安卓平台 JavaScript 自动化工具 (Auto.js 二次开发项目)](https://github.com/supermonster003/Autojs6)
...
[官网 Installation | Playwright](https://playwright.dev/docs/intro)

## eaytier配置文件模板

```yaml
instance_name = "shimple"
